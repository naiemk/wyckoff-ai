...
Currently the NASDAQ Composite has returned to the July 27thBCLX peak. This Resistance level is in force and holding the index back. Provided that it can break out, there are two PnF price objectives that confirm each other. Let’s drill into this recent price structure and see what is going on.
