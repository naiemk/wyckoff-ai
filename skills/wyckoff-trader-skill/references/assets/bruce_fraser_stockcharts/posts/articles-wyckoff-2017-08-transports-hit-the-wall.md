...
A Distribution Point and Figure (PnF) count reveals a price objective comparable to the decline of 2015-16. This prior downward swing was of an intermediate nature and can be studied in more detailby clicking here. Until there is a resolution out of the Distribution area and into a Markdown we will be on the alert for signs of a potential Reaccumulation. Transports move the goods that make the economy go. A vibrant uptrend in the Transports will not only pull the economy forward, but will also lift the stock market as well.
