...
Albemarle (ALB) is a stock we have been following for a while (clickhereandherefor links). Segmenting PnF counts has been an emphasis with ALB. It is time to add Segment C to the Accumulation count. An objective of $146 / $156 is generated. ALB is a dramatic case study of the value of the horizontal PnF method. We began this study when ALB was Jumping out of the Accumulation area above $63. What has happened since?
