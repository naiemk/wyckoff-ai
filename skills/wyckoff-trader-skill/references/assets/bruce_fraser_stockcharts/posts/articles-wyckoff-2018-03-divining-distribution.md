...
Here is a greater than two year UTAD Distribution in the US Dollar Index (UUP). Note the persistent weakness that follows the UTAD and Test. After a SOW below Support a modest rally fails at the Supply trendline (and prior Support) and the weakness resumes. (click hereto see more on UUP and the PnF price objectives).

All the Best,

Bruce

For additional readings on Distribution clickhereandhereandhere.
