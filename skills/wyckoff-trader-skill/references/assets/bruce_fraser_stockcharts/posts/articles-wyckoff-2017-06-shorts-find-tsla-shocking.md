...
Homework: Count the 3rdsegment. Study the PnF chart in the prior TSLA post (click here for a link). Note that each move was preceded by a Cause forming. As Wyckoffians we expect a Cause to precede an Effect. Large Causes lead to large Effects. Small Causes lead to small Effects. Continue to develop this very powerful Wyckoff skill.

For additional reading on the subject of Cause and Effect (clickhereandhereandhere).
