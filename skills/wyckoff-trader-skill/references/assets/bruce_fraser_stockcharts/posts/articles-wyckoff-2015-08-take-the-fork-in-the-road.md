...
This IWM chart was originally published in the June 7thblog (click here for blog). As a homework assignment update the analysis using the schematic above.
